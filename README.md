...
| パス | 内容 | 状態 |
|---|---|---|
| `packages/nene2-tokens` | Core Token Contract v1（color 28＋shadow 4）・CONTRACT_TOKENS export・validate:themes・themegen・codemod 写像表 v1 | 未実装（W0a stage1・契約凍結レビュー 07-18） |
